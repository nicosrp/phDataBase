...
<iframe src="OUTPUT/01_Publications/Publications_per_Year.html" width="100%" height="400" style="border:none; margin-bottom: 20px;"></iframe>

<iframe src="OUTPUT/01_Publications/Publications_per_Year_Bar.html" width="100%" height="400" style="border:none; margin-bottom: 30px;"></iframe>
...
The stacked bar char below shows the total occurence of organizations as coordinators or partners in a project per country.
<iframe src="OUTPUT/02_Organizations_And_Countries/stacked_bar_chart.html" width="100%" height="500" style="border:none; margin-bottom: 20px;"></iframe>


The world maps visualizes the previous involvement values.

<iframe src="OUTPUT/02_Organizations_And_Countries/world_map_company_involvement_globe.html" width="110%" height="650" style="border:none; margin-bottom: 20px;"></iframe>
